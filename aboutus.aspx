<%@ Page Language="C#" AutoEventWireup="true" CodeFile="aboutus.aspx.cs" Inherits="_aboutus" %>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6 order-1 order-lg-2">
           <img src="assets/img/tower.jpg" class="img-fluid" alt=""/>  
          </div>
    ...
    <section id="featured-members" class="featured-members">
      <div class="container">
        ...
        <div class="row content">
          <div class="col-lg-6">
          <img src="assets/img/germancity.jpeg" class="img-fluid" alt="">
          </div>
        ...
        <div class="row content">
          <div class="col-lg-6 order-1 order-lg-2">
            <img src="assets/img/spain.jpg" class="img-fluid" alt="">
          </div>
        ...
        <div class="row content">
          <div class="col-lg-6">
             <img src="assets/img/Japan-city.jpg" class="img-fluid" alt="">
          </div>
          <div class="col-lg-6 pt-3 pt-lg-0">
